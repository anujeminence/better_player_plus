...
abstract class BetterPlayerControlsState<T extends StatefulWidget>
    ...
    if (latestValue != null) {
      ...
      final skip =
          (latestValue!.position -
              Duration(milliseconds: betterPlayerControlsConfiguration
      ...
      child: Container(
        child: Column(
          children: [
            ...
            if (betterPlayerControlsConfiguration.overflowMenuCustomItems
                .isNotEmpty)
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Icon(icon, color: betterPlayerControlsConfiguration
  ...
  Widget _buildSpeedRow(double value) {
    final bool isSelected = betterPlayerController!.videoPlayerController!.value
        .speed == value;
  ...
  void _showSubtitlesSelectionWidget() {
    ...
    final noneSubtitlesElementExists =
        subtitles.firstWhereOrNull((source) =>
        source.type == BetterPlayerSubtitlesSourceType.none) != null;
  ...
  Widget _buildSubtitlesSourceRow(BetterPlayerSubtitlesSource subtitlesSource) {
    final selectedSourceType = betterPlayerController!
  ...
  void _showQualitiesSelectionWidget() {
    // HLS / DASH
    final List<String> asmsTrackNames = betterPlayerController!
        .betterPlayerDataSource!.asmsTrackNames ?? [];
    final List<BetterPlayerAsmsTrack> asmsTracks = betterPlayerController!
    ...
    // normal videos
    final resolutions = betterPlayerController!.betterPlayerDataSource!
        .resolutions;
  ...
  Widget _buildTrackRow(BetterPlayerAsmsTrack track, String? preferredName) {
    ...
    final String trackName = preferredName ??
        '${height}p ${BetterPlayerUtils.formatBitrate(bitrate)}';

    final BetterPlayerAsmsTrack? selectedTrack = betterPlayerController!
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 16),
            Text(
                trackName, style: _getOverflowMenuElementTextStyle(isSelected)),
          ],
        ),
      ),
    );
  ...
  void _showAudioTracksSelectionWidget() {
    //HLS / DASH
    final List<BetterPlayerAsmsAudioTrack>? asmsTracks = betterPlayerController!
        .betterPlayerAsmsAudioTracks;
    final List<Widget> children = [];
    final BetterPlayerAsmsAudioTrack? selectedAsmsAudioTrack = betterPlayerController!
  ...
  void _showMaterialBottomSheet(List<Widget> children) {
    showModalBottomSheet<void>(
        ...
        context: context,
        useRootNavigator: betterPlayerController?.betterPlayerConfiguration
